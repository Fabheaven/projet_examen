 ...
 */
final class Version20250204192841 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE activity (id INT AUTO_INCREMENT NOT NULL, mediafile_id INT DEFAULT NULL, category_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, price NUMERIC(10, 2) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', state VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_AC74095A989D9B62 (slug), UNIQUE INDEX UNIQ_AC74095AD6810431 (mediafile_id), INDEX IDX_AC74095A12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE circuit (id INT AUTO_INCREMENT NOT NULL, mediafile_id INT DEFAULT NULL, category_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, price NUMERIC(10, 2) NOT NULL, duration INT NOT NULL, availability TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', state VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_1325F3A6989D9B62 (slug), UNIQUE INDEX UNIQ_1325F3A6D6810431 (mediafile_id), INDEX IDX_1325F3A612469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE circuit_activity (circuit_id INT NOT NULL, activity_id INT NOT NULL, INDEX IDX_7C29C2FBCF2182C8 (circuit_id), INDEX IDX_7C29C2FB81C06096 (activity_id), PRIMARY KEY(circuit_id, activity_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE circuit ADD CONSTRAINT FK_1325F3A612469DE2 FOREIGN KEY (category_id) REFERENCES category (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE circuit DROP FOREIGN KEY FK_1325F3A612469DE2');
